<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeployLineMgr_xsl.aspx.cs" Inherits="DeployList_DeployLineMgr_xsl" %>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="BTable" style="clear: both; margin: 0; padding: 0;">
			<thead>
				<tr class="BTable_bg02" style="height:25px;background-color: #f5ebe2;color: #823300;">
					  ...
					  <td  nowrap="t" width="30%" height="25" align="center" valign="middle" class="table_mgraybg" style="font-size:9pt;"><b><%= Resources.Approval.lbl_Dployline_name%></b></td>
			...
			<xsl:for-each select="response/item">
				<tr><xsl:attribute name="id"><xsl:value-of select="id"/></xsl:attribute>
					...
					<td nowrap="t" valign="middle"  onclick="showList(this);" style="cursor:hand;"><xsl:attribute name="id">td_<xsl:value-of
                            select="id" />
                        </xsl:attribute><xsl:value-of select="signlistname"/></td>
					<td nowrap="t"></td>
					<td nowrap="t" ><xsl:value-of select="dscr"/></td>
				</tr>
				<tr>
