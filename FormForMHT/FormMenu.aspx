<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormMenu.aspx.cs" Inherits="COVIFlowNet_FormsForMHT_FormMenu" %>
...
<!--	디버깅용 요소임-->
	...
	<div class="Approval_Btn" id="divMenu">
		...
		<div style="width: 800px; height: 27px; background: url(<%=Session["user_thema"] %>/Covi/Common/btn/btn_group03_bg.gif); padding-top: 4px;padding-left:10px; padding-right:10px;">
			...
			<!-- 편집 --><span id="btModify" name="cbBTN" onclick="doButtonAction(this);" style="display:none;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_generic.gif" align="middle" /><%= Resources.Approval.btn_modify %></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
			...
			<!-- 반려 --><span id="btReject" name="cbBTN" onclick="doButtonAction(this);" style="display:none;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_rejection.gif" align="middle" /><span id="spanbtReject"><%= Resources.Approval.lbl_reject %></span></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
			...
			<!-- 접수 --><span id="btRec" name="cbBTN" onclick="doButtonAction(this);" style="display:none;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_generic.gif" align="middle" /><span id="spnReceipt"><%= Resources.Approval.btn_receipt %></span></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
			<!-- 결재선 --><span id="btDeptLine" name="cbBTN" onclick="doButtonAction(this);" style="display:none;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_decide-sch.gif" align="middle" /><span id="spnApprovalLine"><%= Resources.Approval.lbl_assignapprover %></span></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
			...
			<!--가이드--><span id="btnGuide" onclick="event();"  style="display:none" ><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_p-manual.gif" align="middle" alt="<%= Resources.Approval.btn_guide %>" /><%= Resources.Approval.btn_guide %></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>	
			...
			<!-- 확인 --><span style="display:none;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_generic.gif" align="middle" /><%= Resources.Approval.btn_confirm %></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
