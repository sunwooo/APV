<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<response>
		<addresslist>
			<xsl:for-each select="addresslist/item" >
        <xsl:sort select="number(SO)"/>
        <item>
...
<ETID><xsl:value-of select="ETIC"/></ETID>
<ETNM><xsl:value-of select="ETNM"/></ETNM>
<SIP><xsl:value-of select="SIP" /></SIP>
<USEC><xsl:value-of select="USEC" /></USEC>
</item>
</xsl:for-each>
</addresslist>
</response>
