<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comment_add.aspx.cs" Inherits="COVIFlowNet_Comment_comment_add" %>
...
<div class="popup_Btn small AlignR">    
    ...
    <asp:LinkButton ID="btnDel" CssClass="Btn04" runat="server" OnClick="BtnDel_Click" Text="" EnableTheming="True" UseSubmitBehavior="False" />
