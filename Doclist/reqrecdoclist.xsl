...
<xsl:template match="response">
		...
		<THEAD>
			<tr>
				...
				<TD align="center" valign="middle" class="table_mgreenbg" id="thAD" noWrap="t" width="120" onClick="sortColumn('rgdt');" style="cursor:hand;">접수일자</TD>
				<TD align="center" valign="middle" class="table_green" id="thSN" noWrap="t" width="100" onClick="sortColumn('senounm');" style="cursor:hand;">발 신</TD>
				<TD align="center" valign="middle" class="table_mgreenbg" id="thDN"  onClick="sortColumn('docsubject');" style="cursor:hand;">제목</TD>
				<TD align="center" valign="middle" class="table_green" id="thEF" noWrap="t" width="70">인수자명</TD>
