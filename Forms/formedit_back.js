...
function SetSubjectTbxSync() {
    ...
    try {
        ...
        //원본
        //var vSubjectTmp = document.getElementsByName("SUBJECT")[0].value.replace(/\\/g, "￦");
        ////var vSubjectTmp = document.getElementsByName("SUBJECT")[0];
        //if (vSubjectTmp.indexOf("'") > -1)
        //    document.getElementsByName("SUBJECT")[0].value = ReplaceChars(vSubjectTmp, "'", "`");
        //TagfreeScriptEditor.document.getElementById("tdSubject").innerHTML = "<p align='left'>&nbsp;" + document.getElementsByName("SUBJECT")[0].value.replace(/\\/g, "￦") + "</p>";
        //원본
        ...
        d5Dom.document.getElementById("tdSubject").innerHTML = "<p align='left'>&nbsp;" + document.getElementsByName("SUBJECT")[0].value.replace(/\\/g, "￦") + "</p>";
