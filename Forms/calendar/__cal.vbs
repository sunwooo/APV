...
intNextYY	= intThisYear + 1
	...
	Cal_HTML=Cal_HTML& "<td></td><td style='color:white;font-weight:bold'>일</td><td style='color:white;font-weight:bold'>월</td><td style='color:white;font-weight:bold'>화</td><td style='color:white;font-weight:bold'>수</td><td style='color:white;font-weight:bold'>목</td><td style='color:white;font-weight:bold'>금</td><td style='color:white;font-weight:bold'>토</td><td></td>"
	Cal_HTML=Cal_HTML& "</tr>"
