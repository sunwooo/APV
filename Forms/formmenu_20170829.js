    ...
    switch(getInfo("loct")){
		...
		case "REJECT":
		    ...
		    if ((getInfo("loct") == "COMPLETE" || getInfo("loct") == "REJECT") && getInfo("INITIATOR_ID") == getInfo("usid")) {
		        if (getInfo("fmpf") == "WF_SLIP" || getInfo("fmpf") == "WF_FORM_COMMON_BUDGET_CHG") {
		    ...
		    if ((getInfo("loct") == "COMPLETE" || getInfo("loct") == "REJECT") && getInfo("INITIATOR_ID") == getInfo("usid")) {
		        if (getInfo("fmpf") == "WF_SLIP" || getInfo("fmpf") == "WF_FORM_COMMON_VACATION" || getInfo("fmpf") == "WF_FORM_COMMON_VACA_REGIST" || getInfo("fmpf") == "WF_FORM_COMMON_VACA_CANCEL") { //
		            document.getElementById("btReUse").style.display = "none";
		        }
		        else {
		            document.getElementById("btReUse").style.display = "";
