<%@ Page Language="C#" AutoEventWireup="true" CodeFile="faxdocumentmenu.aspx.cs" Inherits="Approval_Forms_faxdocumentmenu" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		<script type="text/javascript" language="javascript" src="faxdocumentmenu.js"></script>
	</head>
        ...
        <div class="Approval_Btn" id="divMenu">   
            <div style="width: 800px; height: 27px; background: url(<%=Session["user_thema"] %>/Covi/Common/btn/btn_group03_bg.gif); padding-top: 4px;padding-left:10px; padding-right:10px;">
                <span >
                    ...
                    <!-- 저장    --><span id="btSave" name="cbBTN" onclick="doButtonAction2(this);" style="display:;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_generic.gif" align="middle" /><%= Resources.Approval.btn_save%></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
                ...
                <span align="right">
			        ...
			        <!-- 닫기(preview) --><span id="btExitPreView" name="btExitPreView" onclick="javascript:top.close();" style="display:;"><a href="#" class="Btn_Group03"><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon03_close.gif" align="middle" /><%= Resources.Approval.btn_close %></a><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_Group01_line.gif" align="absmiddle" class="btn_line" /></span>
                </span>
		    </div>
		</div>
