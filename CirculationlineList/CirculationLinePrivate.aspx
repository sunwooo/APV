<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="CirculationLinePrivate.aspx.cs" Inherits="COVIFlowNet_CirculationlineList_CirculationLinePrivate"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CirculationMgr.js" ></script>
...
<div class="popup_left" id="divleft" name="divleft">
  ...
  <div class="tab01 small">
    <ul>
      <li id="divtSearch"><a href="#"  onclick="javascript:changeTab(this);" id="tSearch" name="tSearch"><span><%= Resources.Approval.lbl_search %></span></a><!--검색--></li>      
  ...
  <div class="iframe_border">
    <iframe id="ListItems" name="ListItems" width="100%" height="209" frameborder="0" src="../Address/listitems.aspx" style='scroll:auto'></iframe>
  </div>
</div>
<!-- 왼쪽 div 끝 -->

<!-- 가운데 div 시작 -->
<div class="popup_center" style="display:table; height:432px; *position:relative;">
  <div class="Btn" style="display:table-cell; vertical-align:middle; text-align:center; *display:inline-block; *position:absolute; *top:50%; *left:50%;">
    <ul>        
    <!-- 배포자 --><li id="tblCirculation"><a href="#" class="Btn06" id="btCirculation" name="cbBTN" onclick="doButtonAction(this);"><span><%= Resources.Approval.lbl_circulation_person %><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon06_blt.gif" align="absmiddle" /></span></a></li>
    <!-- 배포부서 --><li id="tblCirculationDept"><a href="#" class="Btn06" id="btCirculationDept" name="cbBTN" onclick="doButtonAction(this);"><span><%= Resources.Approval.lbl_circulation_dept %><img src="<%=Session["user_thema"] %>/Covi/Common/btn/btn_icon06_blt.gif" align="absmiddle" /></span></a></li>	    
    </ul>
  </div>
</div>
<!-- 가운데 div 끝 -->
...
<div class="popup_right">
    ...
    <div id="divccinfomain" name="divccinfomain">
        <!-- 타이틀 & 버튼 div 시작 -->  
        <div class="title" >
			<div class="text"><h3><%= Resources.Approval.lbl_circulation_list %></h3></div>
			<div class="Btn">
			  <ul>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
		        <td id="tdrefinfo" name="tdrefinfo" height="100%" valign="top">
			        <div id="divrefinfo" name="divrefinfo"  class="BTable">					    
				        <table width="100%" id="tdrefinfo" name="tdrefinfo" border="0" cellspacing="0" cellpadding="0">					       
					        <tr class="BTable_bg02" style="height:27px">
                              ...
                              <th width="46%" align="center" valign="middle" class="td01_app"><%= Resources.Approval.lbl_dept %></th>
                              <th width="46%" align="center" valign="middle" class="td01_app"><%= Resources.Approval.lbl_Name %></th>
                            </tr>
					        <tr>
                                <td height="1" colspan="3" class="BTable_bg03"></td>
                            </tr>
                            <tr>
	                            <td  colspan="6" height="368" >                            
			...
			if ((selTab == 'tSearch' && ((iType==3 && !iSearch.document.getElementById("buse").checked) || (iType==4 && iSearch.document.getElementById("buse").checked))) || selTab == 'tGroup'){
				if (sChk == "1"){
					...
					if(typeof(chk_count) == "undefined"){
						//var eTR = m_oUserList.document.getElementById("chkRowSelect").parentElement;
