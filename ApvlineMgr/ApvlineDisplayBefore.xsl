		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<xsl:choose>
				<xsl:when test="$viewtype='create'">
					<tr>
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg" widtd="50" >순 번</td>
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg">이 름</td>
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg">직 책</td>						
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg">직 급</td>
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg" widtd="80">상 태</td>
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg" widtd="80">종 류</td>
						<td height="20"  align="center" nowrap="t"  class="table_mgraybg">부 서</td>
					</tr>
					<tr>
				...
				<xsl:when test="$viewtype='read'">
					<tr>
						...
						<td height="20"  align="center" valign="middle" class="table_mgreenbg" nowrap="t">직 책</td>						
						<td height="20"  align="center" valign="middle" class="table_mgreenbg" nowrap="t">직 급</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">상 태</td>
						<td height="20"  align="center" valign="middle" class="table_mgreenbg" nowrap="t">종 류</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">부 서</td>
						<td height="20"  align="center" valign="middle" class="table_mgreenbg" nowrap="t">결재일자</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">받은일자</td>
						<td height="20"  align="center" valign="middle" class="table_mgreenbg" nowrap="t">의 견</td>
					</tr>
					<tr>
				...
				<xsl:when test="$viewtype='change'">
					<tr>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">순 번</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">이 름</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">직 책</td>						
						<!--<td height="25"  align="center"  nowrap="t"  class="table_mgraybg">직 급</td>-->
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">상 태</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">종 류</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">부 서</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">결재일자</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">받은일자</td>
						<td height="20"  align="center"  nowrap="t"  class="table_mgraybg">의 견</td>
					</tr>
					<tr>
