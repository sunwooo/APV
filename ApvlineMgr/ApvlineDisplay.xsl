...
<xsl:stylesheet version="1.0"
	...
	<msxsl:script language="javascript" implements-prefix="cfxsl">
	<![CDATA[
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<xsl:choose>
				<xsl:when test="$viewtype='create'">
					<tr>
						<td height="20"  align="center" nowrap="t"  class="table_green" widtd="50" >순 번</td>
						<td height="20"  align="center" nowrap="t"  class="table_green">이 름</td>
						<td height="20"  align="center" nowrap="t"  class="table_green">직 책</td>						
						<td height="20"  align="center" nowrap="t"  class="table_green">직 급</td>
						<td height="20"  align="center" nowrap="t"  class="table_green" widtd="80">상 태</td>
						<td height="20"  align="center" nowrap="t"  class="table_green" widtd="80">종 류</td>
						<td height="20"  align="center" nowrap="t"  class="table_green">부 서</td>
					</tr>
					<tr>
				...
				<xsl:when test="$viewtype='read'">
					<tr>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">순 번</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">이 름</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">직 책</td>						
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">직 급</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">상 태</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">종 류</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">부 서</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">결재일자</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">받은일자</td>
						<td height="20"  align="center" valign="middle" class="table_green" nowrap="t">의 견</td>
					</tr>
					<tr>
						<td height="1" colspan="10" align="center"  class="table_line"></td>
					</tr>
				</xsl:when>
				<xsl:when test="$viewtype='change'">
					<tr>
						<td height="20" align="center"  nowrap="t"  class="table_green">순 번</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">이 름</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">직 책</td>						
						<td height="25" align="center"  nowrap="t"  class="table_green">직 급</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">상 태</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">종 류</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">부 서</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">결재일자</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">받은일자</td>
						<td height="20" align="center"  nowrap="t"  class="table_green">의 견</td>
					</tr>
					<tr>
						<td height="1" colspan="10" align="center"  class="table_line"></td>
					</tr>
	...
	<xsl:template name="htmlrow" match="*">
		...
		<xsl:choose>
			<xsl:when test="$viewtype='create'">
				<tr onmousedown="selectRow()" align="center">
	...
	<xsl:template name="displaycomment" match="*">
		...
		<a><xsl:attribute name="href">
			<xsl:text>javascript:parent.viewComment("</xsl:text><xsl:value-of select="$commentkey"/><xsl:text>")</xsl:text>
		</xsl:attribute>의견</a>
		<div style="display:none">
			<xsl:attribute name="id"><xsl:value-of select="$commentkey"/></xsl:attribute>
			<xsl:apply-templates select="$itemtaskinfo/comment"/>
		</div>
	</xsl:template>
	
	<xsl:template match="comment">
		<b><xsl:value-of select="cfxsl:convertSignResult(string(@relatedresult),string(@kind))"/></b>-<xsl:value-of select="@datecommented"/>
